...
public class DruidUtil {
    ...
    public static DruidDataSource createDataSource() {
        ...
        // 设置驱动全类名
        druidDataSource.setDriverClassName("org.apache.phoenix.jdbc.PhoenixDriver");
        // 设置连接 url
        druidDataSource.setUrl("jdbc:phoenix:hadoop102,hadoop103,hadoop104:2181");
        // 设置初始化连接池时池中连接的数量
